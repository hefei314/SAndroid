...
import com.zhihu.matisse.internal.permission.EasyPermission;
import com.zhihu.matisse.internal.permission.GrantResult;
import com.zhihu.matisse.internal.permission.PermissionRequestListener;
        ...
        EasyPermission.with(activity)
                ...
                .request(new PermissionRequestListener() {
                    ...
                    public void onGrant(Map<String, GrantResult> result) {
                        if (result.get(Manifest.permission.READ_EXTERNAL_STORAGE).getValue() == PackageManager.PERMISSION_GRANTED
                                && result.get(Manifest.permission.WRITE_EXTERNAL_STORAGE).getValue() == PackageManager.PERMISSION_GRANTED
                                && result.get(Manifest.permission.CAMERA).getValue() == PackageManager.PERMISSION_GRANTED
                                && result.get(Manifest.permission.RECORD_AUDIO).getValue() == PackageManager.PERMISSION_GRANTED) {
                            ...
                            Toast.makeText(activity, R.string.error_privilege_missing, Toast.LENGTH_LONG).show();
                        }
                    }
